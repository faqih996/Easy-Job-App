                    ...
                    <div class="w-[52px] h-[52px] flex shrink-0 rounded-full overflow-hidden">
                        <a href="{{ route('dashboard') }}">
                            <img src="{{ Storage::url(Auth::user()->avatar) }}"
                                class="items-center object-cover w-full h-full text-center align-center" alt="avatar"></a>
                    </div>
                </div>
            @endauth
        </nav>

        <form method="POST" action="{{ route('front.apply.store', $companyJob->slug) }}" enctype="multipart/form-data"
            ...
            <div id="Feature" class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-[6px]">
                    ...
                    <p class="font-semibold text-lg leading-[27px]">Rp
                        {{ number_format($companyJob->salary, 0, ',', '.') }}/mo
                    </p>
                </div>
                <div class="flex items-center gap-[6px]">
                    <div class="flex shrink-0 w-[38px] h-[38px]">
            ...
            @if ($errors->any())
                <div class="w-full py-3 text-white bg-red-500 rounded-lg alert alert-danger">
            ...
            <div id="Cover-Letter-Container" class="flex flex-col gap-4">
                ...
                <div
                    ...
                    <textarea name="message" id="coverLetter" rows="9"
                        class="appearance-none outline-none w-full font-semibold placeholder:text-[#0E0140]"
