    ...
    <ul class="flex items-center gap-10">
        <li>
            <a href="{{ route('front.index') }}"
                class="transition-all duration-300 hover:font-semibold hover:text-[#FF6B2C] {{ request()->routeIs('front.index') ? 'font-semibold text-[#FF6B2C]' : 'font-medium text-white' }}">Home</a>
        </li>
        <li>
            <a href=""
